...
To build the final jar and optimize the cofinexOnChainScannerBNB application for production, run:
...
Then navigate to [http://localhost:70001](http://localhost:70001) in your browser.
