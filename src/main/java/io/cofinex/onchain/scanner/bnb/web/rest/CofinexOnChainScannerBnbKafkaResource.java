...
@RestController
@RequestMapping("/api/cofinex-on-chain-scanner-bnb-kafka")
public class CofinexOnChainScannerBnbKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CofinexOnChainScannerBnbKafkaResource.class);
    ...
    public CofinexOnChainScannerBnbKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
